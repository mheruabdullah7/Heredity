...
if (pilihanGanda) {
  pilihanGanda.innerHTML += `
          <div class="div-soal ${tampilanSoal} px-2">
              ...
              <div class="lg-lh text-break mx-2 soalteks" id="soalTeks${i}">${data[`Soal_Kuis_2_${i}`]["teks-soal"]}</div>
