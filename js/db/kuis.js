    ...
    if(data[`skor`] == ""){
      ...
      <div class="card-body">
        ...
        <div class="d-md-flex justify-content-md-center text-decoration-none tombol-hasil-kuis">
          ...
          <button href="kuis1.html" class="btn btn-danger mx-2" id="ulangi-kuis" >Ulang Kuis <i class="fas fa-undo-alt"></i></button>
        </div>
      </div>`
      ...
      // const pilihanGanda = document.querySelector(".pilihan-ganda");
        ...
        for (let i = 1; i <= 10; i++) {
          ...
          <div class="div-soal ${tampilanSoal} px-2">
              ...
              <div class="lg-lh text-break mx-2 soalteks" id="soalTeks${i}">${data[`Soal_Kuis_1_${i}`]["teks-soal"]}</div>
