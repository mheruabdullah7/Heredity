      ...
      if($('#kelas').val() == ""){
        ...
        getDataSiswa.then(users => {
          ...
          $('#example').DataTable({
            ...
            'rt' + 
            '<"bottom"<"d-flex justify-content-between"ip>><"clear">',
            scrollY: 'calc(100vh - 365px)', // Mengatur tinggi scrollY
            scrollCollapse: true,
            language: {
              paginate: {
                next: 'Selanjutnya',
            ...
            buttons: [
              {
                ...
                text: '<i class="fas fa-file-pdf"></i> PDF', // Teks tombol dengan ikon
                className: 'btn btn-danger', // Gaya tombol
                filename: 'Rekap Evaluasi Kelas '+ ($('#kelas option:selected').text()), // Nama file yang diunduh
                title: 'Rekap Evaluasi Kelas '+ ($('#kelas option:selected').text()), // Judul  khusus
                customize: function(doc) {
              ...
              },
              {
                extend: 'print',
                text: '<i class="fa-sharp fa-solid fa-print"></i> Print', // Teks tombol dengan ikon
                title: 'Rekap Evaluasi Kelas '+ ($('#kelas option:selected').text()), // Judul cetak khusus
                className: 'btn btn-secondary', // Gaya tombol
                customize: function(win) {
                  // Mengubah gaya cetak
                  $(win.document.body).addClass('new-print-style');
